import 'package:desafio5/invoice/models/card_type.dart';
...
class CardUtils {
  static String? validateCVV(String? value, context) {
    if (value == null || value.isEmpty) {
      return context == null ? "Required Field" : AppLocalizations.of(context)!.requiredField;
    }
  ...
  static String? validateDate(String? value, BuildContext? context) {
    ...
    if ((month < 1) || (month > 12)) {
      ...
      return context == null ? "Expiry month is invalid" : AppLocalizations.of(context)!.expiryMonthInvalid;
    }
    ...
    if ((fourDigitsYear < 1) || (fourDigitsYear > 2099)) {
      ...
      return context == null ? "Expiry year is invalid" : AppLocalizations.of(context)!.expiryYearInvalid;
    }
  ...
  static String? validateCardNum(String? input, BuildContext? context) {
    ...
    return context == null ? "Invalid credit card" : AppLocalizations.of(context)!.invalidCreditCard;
  }
